...
<div class="wrapper row2">
  <form method="post" enctype="multipart/form-data" action="{{ url('/editfacturamateriales') }}" autocomplete="off" data-toogle="validator" role="form" id="logo_form">
    {{ csrf_field() }}
    <br>
    <h3>Mano de obra</h3>
    <table id="customers">
...
<!--1-->
        ...
        @else
          <td><input type="text" name="denominacion01" value="{!!$manodeobra1->nombre!!}" /></td> 
          <td><input type="number" step=".01" name="tiempo01" value="{!!$manodeobra1->tiempo!!}" id="tiempo01" onchange="setTotal1();"/></td> 
          <td><input type="number" step=".01" name="precio01" value="{!!$datos->euroshora!!}" id="precio01"disabled/></td> 
          <td><input type="number" step=".01" name="importe01" value="{!!$manodeobra1->importe!!}" id="total01" /></td>
          <input hidden type="text" name="manodeobra1" value="{!!$manodeobra1->id!!}" />
          <td><a href="#" id="showtabla2" class="button">+</a></td> 
        @endif
        </tr> 
<!--2-->
        ...
        @else
        <tr id="tabla2"> 
          <td><input type="text" name="denominacion02" value="{!!$manodeobra2->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo02" value="{!!$manodeobra2->tiempo!!}" id="tiempo02" onchange="setTotal2();"/></td> 
          <td><input type="number" step="any" name="precio02" value="{!!$datos->euroshora!!}" id="precio02"disabled/></td> 
          <td><input type="number" step="any" name="importe02" value="{!!$manodeobra2->importe!!}" id="total02" /></td>
          <input hidden type="text" name="manodeobra2" value="{!!$manodeobra2->id!!}" />
          <td><a href="#" id="showtabla3" class="button">+</a></td>
        @endif
        </tr>
<!--3-->
        ...
        @else
        <tr id="tabla3"> 
          <td><input type="text" name="denominacion03" value="{!!$manodeobra3->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo03" value="{!!$manodeobra3->tiempo!!}" id="tiempo03" onchange="setTotal3();"/></td> 
          <td><input type="number" step="any" name="precio03" value="{!!$datos->euroshora!!}" id="precio03"disabled/></td> 
          <td><input type="number" step="any" name="importe03" value="{!!$manodeobra3->importe!!}" id="total03" /></td>
          <input hidden type="text" name="manodeobra3" value="{!!$manodeobra3->id!!}" />
          <td><a href="#" id="showtabla4" class="button">+</a></td> 
        @endif
        </tr>
<!--4-->
        ...
        @else
        <tr id="tabla4"> 
          <td><input type="text" name="denominacion04" value="{!!$manodeobra4->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo04" value="{!!$manodeobra4->tiempo!!}" id="tiempo04" onchange="setTotal4();"/></td> 
          <td><input type="number" step="any" name="precio04" value="{!!$datos->euroshora!!}" id="precio04"disabled/></td> 
          <td><input type="number" step="any" name="importe04" value="{!!$manodeobra4->importe!!}" id="total04" /></td>
          <input hidden type="text" name="manodeobra4" value="{!!$manodeobra4->id!!}" />
          <td><a href="#" id="showtabla5" class="button">+</a></td> 
        @endif
        </tr>
<!--5-->
        ...
        @else
        <tr id="tabla5"> 
          <td><input type="text" name="denominacion05" value="{!!$manodeobra5->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo05" value="{!!$manodeobra5->tiempo!!}" id="tiempo05" onchange="setTotal5();"/></td> 
          <td><input type="number" step="any" name="precio05" value="{!!$datos->euroshora!!}" id="precio05"disabled/></td> 
          <td><input type="number" step="any" name="importe05" value="{!!$manodeobra5->importe!!}" id="total05" /></td>
          <input hidden type="text" name="manodeobra5" value="{!!$manodeobra5->id!!}" />
          <td><a href="#" id="showtabla6" class="button">+</a></td>
        @endif
        </tr>
<!--6-->
        ...
        @else
        <tr id="tabla6"> 
          <td><input type="text" name="denominacion06" value="{!!$manodeobra6->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo06" value="{!!$manodeobra6->tiempo!!}" id="tiempo06" onchange="setTotal6();"/></td> 
          <td><input type="number" step="any" name="precio06" value="{!!$datos->euroshora!!}" id="precio06"disabled/></td> 
          <td><input type="number" step="any" name="importe06" value="{!!$manodeobra6->importe!!}" id="total06" /></td>
          <input hidden type="text" name="manodeobra6" value="{!!$manodeobra6->id!!}" />
          <td><a href="#" id="showtabla7" class="button">+</a></td>
        @endif
        </tr>
<!--7-->
        ...
        @else
        <tr id="tabla7"> 
          <td><input type="text" name="denominacion07" value="{!!$manodeobra7->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo07" value="{!!$manodeobra7->tiempo!!}" id="tiempo07" onchange="setTotal7();"/></td> 
          <td><input type="number" step="any" name="precio07" value="{!!$datos->euroshora!!}" id="precio07"disabled/></td> 
          <td><input type="number" step="any" name="importe07" value="{!!$manodeobra7->importe!!}" id="total07" /></td>
          <input hidden type="text" name="manodeobra7" value="{!!$manodeobra7->id!!}" />
          <td><a href="#" id="showtabla8" class="button">+</a></td>
        @endif
        </tr>
<!--8-->
        ...
        @else
        <tr id="tabla8"> 
          <td><input type="text" name="denominacion08" value="{!!$manodeobra8->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo08" value="{!!$manodeobra8->tiempo!!}" id="tiempo08" onchange="setTotal8();"/></td> 
          <td><input type="number" step="any" name="precio08" value="{!!$datos->euroshora!!}" id="precio08"disabled/></td> 
          <td><input type="number" step="any" name="importe08" value="{!!$manodeobra8->importe!!}" id="total08" /></td>
          <input hidden type="text" name="manodeobra8" value="{!!$manodeobra8->id!!}" />
          <td><a href="#" id="showtabla9" class="button">+</a></td>
        @endif
        </tr>
<!--9-->
        ...
        @else
        <tr id="tabla9"> 
          <td><input type="text" name="denominacion09" value="{!!$manodeobra9->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo09" value="{!!$manodeobra9->tiempo!!}" id="tiempo09" onchange="setTotal9();"/></td> 
          <td><input type="number" step="any" name="precio09" value="{!!$datos->euroshora!!}" id="precio09"disabled/></td> 
          <td><input type="number" step="any" name="importe09" value="{!!$manodeobra9->importe!!}" id="total09" /></td>
          <input hidden type="text" name="manodeobra9" value="{!!$manodeobra9->id!!}" />
          <td><a href="#" id="showtabla10" class="button">+</a></td>
        @endif
        </tr>
<!--10-->
        @if($manodeobra10 == null)
        ...
        @else
        <tr id="tabla10"> 
          <td><input type="text" name="denominacion10" value="{!!$manodeobra10->nombre!!}" /></td> 
          <td><input type="number" step="any" name="tiempo10" value="{!!$manodeobra10->tiempo!!}" id="tiempo10" onchange="setTotal10();"/></td> 
          <td><input type="number" step="any" name="precio10" value="{!!$datos->euroshora!!}" id="precio10"disabled/></td> 
          <td><input type="number" step="any" name="importe10" value="{!!$manodeobra10->importe!!}" id="total10" /></td>
          <input hidden type="text" name="manodeobra10" value="{!!$manodeobra10->id!!}" />
        @endif
        </tr>
      </tbody>  
    </table>
