...
<div class="wrapper row2">
  <form method="post" enctype="multipart/form-data" action="{{ url('/editfacturamanodeobra') }}" autocomplete="off" data-toogle="validator" role="form" id="logo_form">
    {{ csrf_field() }}
    <table id="customers2">
      <tbody>
        <tr>
          ...
          <td>
            ...
            <nav>
              <ul>
                <li>Matricula: <input type="text" name="kms" value="{!!$factura->vehiculo->matricula!!}" required/></li></li>
                <li>Marca: <input type="text" name="kms" value="{!!$factura->vehiculo->marca!!}" required/></li></li>
                <li>Modelo: <input type="text" name="kms" value="{!!$factura->vehiculo->modelo!!}" required/></li></li>
                <li>Kilometros: <input type="text" name="kms" value="{!!$factura->kms!!}" required/></li>
              </ul>
            </nav>
          </td>
        </tr>
      ...
      <tbody>
        <tr>
          <td>
            <nav>
              <ul>
                <li><input type="text" name="nombre" value="{!!$factura->cliente->nombre!!}" placeholder="Nombre" size="10" required/><input type="text" name="apellido" value="{!!$factura->cliente->apellido!!}" placeholder="Apellido" size="10" required/></li>
                <li><input type="text" name="dni" value="{!!$factura->cliente->cifdni!!}" placeholder="DNI" required/></li>
                <li><input type="text" name="telefono" value="{!!$factura->cliente->telefono!!}" placeholder="Telefono" required/></li>
                <li><input type="text" name="correo" value="{!!$factura->cliente->correo!!}" placeholder="Correo" /></li>
              </ul>
            </nav>
          </td>
          <td>
            <nav>
              <ul>
                <li><input type="text" name="calle" value="{!!$factura->cliente->calle!!}" placeholder="Calle" /></li>
                <li><input type="text" name="portal" value="{!!$factura->cliente->portal!!}" placeholder="Portal" maxlength="4" size="2" /><input type="text" name="piso" value="{!!$factura->cliente->piso!!}" placeholder="Piso" maxlength="4" size="2" /><input type="text" name="puerta" value="{!!$factura->cliente->puerta!!}" placeholder="Puerta" maxlength="4" size="2" /></li>
                <li><input type="text" name="cod_postal" value="{!!$factura->cliente->cod_postal!!}" placeholder="Cod. Postal" size="7" /><input type="text" name="poblacion" value="{!!$factura->cliente->poblacion!!}" placeholder="Poblacion" size="7" /></li>
                <li><input type="text" name="provincia" value="{!!$factura->cliente->provincia!!}" placeholder="Provincia" /></li>
              </ul>
            </nav>
          </td>
        </tr>
    ...
    <br>
        ...
        <input hidden type="text" name="id" value="{!!$factura->id!!}" required/>
        <a href="{{ route('dashboard') }}" class="btn btn-primary button">Volver</a><button type="submit" class="btn btn-primary button" style="float:right;">editar mano de obra</button>
        </form>
      </div>
    </div>
  </div>
